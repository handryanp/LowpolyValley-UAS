...
public class BuildTargetSelection : MonoBehaviour {
    ...
    static bool VMac() { return buildTarget == BuildTarget.StandaloneOSX; }

    [MenuItem("Ravenfield Tools/Build Target/Linux", true)]
    static bool VLinux() { return buildTarget == BuildTarget.StandaloneLinux64; }
}
